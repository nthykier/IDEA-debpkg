...
public class Deb822GpgSignatureImpl extends ASTWrapperPsiElement implements Deb822GpgSignature {

  public Deb822GpgSignatureImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Deb822Visitor visitor) {
    visitor.visitGpgSignature(this);
  }
