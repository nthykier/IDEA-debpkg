...
public class DepLangVersionOperatorImpl extends ASTWrapperPsiElement implements DepLangVersionOperator {

  public DepLangVersionOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DepLangVisitor visitor) {
    visitor.visitVersionOperator(this);
  }
