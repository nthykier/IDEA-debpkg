...
public class DepLangOrDependencyClauseImpl extends ASTWrapperPsiElement implements DepLangOrDependencyClause {

  public DepLangOrDependencyClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DepLangVisitor visitor) {
    visitor.visitOrDependencyClause(this);
  }
  ...
  @Override
  @NotNull
  public List<DepLangDependency> getDependencyList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DepLangDependency.class);
  }
