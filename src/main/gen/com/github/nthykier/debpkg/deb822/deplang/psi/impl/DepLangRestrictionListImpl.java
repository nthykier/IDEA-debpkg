...
public class DepLangRestrictionListImpl extends ASTWrapperPsiElement implements DepLangRestrictionList {

  public DepLangRestrictionListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DepLangVisitor visitor) {
    visitor.visitRestrictionList(this);
  }
